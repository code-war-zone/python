...
1. [Week 01 – Introduction to Python & Programming Basics](./01-week/README.md)
2. [Week 02 – Data Structures & Algorithms Foundations](./02-week/README.md)
3. [Week 03 – Control Flow, Loops & Program Logic](./03-week/README.md)
4. [Week 04 – Functions, Recursion & Functional Programming](./04-week/README.md)
5. [Week 05 – Object-Oriented Programming (OOP) & Design Principles](./05-week/README.md)
6. [Week 06 – Modules, Packages, Dependency Management & Virtual Environments](./06-week/README.md)
7. [Week 07 – File Handling, Serialization (JSON/CSV/XML), and OS Automation](./07-week/README.md)
8. [Week 08 – Error Handling, Debugging, Logging & Python Internals](./08-week/README.md)
9. [Week 09 – Databases, SQL, and ORMs (SQLite, PostgreSQL, SQLAlchemy)](./09-week/README.md)
